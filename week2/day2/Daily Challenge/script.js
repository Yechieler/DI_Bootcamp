...
console.log(sentence.replace(/not that bad/i,"good"));

let wordNot = 'This movie is not so bad!'
console.log(wordNot.replace(/not so bad/i,"good"));
 
let wordBad = 'This dinner is bad!'
console.log(wordBad.replace(/not so bad/i,"good"));
